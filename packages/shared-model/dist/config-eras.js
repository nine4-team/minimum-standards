...
exports.resolveEraForTimestamp = resolveEraForTimestamp;
exports.buildSnapshotFromEra = buildSnapshotFromEra;
exports.buildSnapshotFromStandard = buildSnapshotFromStandard;
/**
 ...
 */
function resolveEraForTimestamp(standard, timestampMs) {
 ...
 */
function buildSnapshotFromEra(era) {
    return {
        minimum: era.minimum,
        unit: era.unit,
        cadence: era.cadence,
 ...
 */
function buildSnapshotFromStandard(standard) {
    return {
...
//# sourceMappingURL=config-eras.js.map